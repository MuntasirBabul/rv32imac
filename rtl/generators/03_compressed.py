#!/usr/bin/env python3
# generators/03_compressed.py → generates rv32imac_c_decode.svh
...
// DO NOT EDIT – generated by generators/03_compressed.py
...
(OUT / "rv32imac_c_decode.svh").write_text(code)
print("Generated: rv32imac_c_decode.svh → Full C Extension Support!")
